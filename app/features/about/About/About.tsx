  ...
  return (
      <div className='section-content'>
        ...
        <p>
          ...
          Research & Design certification from the University of Michigan. I'm drawn to roles where
          disciplines intersect — where building better processes, systems, and cultures makes
