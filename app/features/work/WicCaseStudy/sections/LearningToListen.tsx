  ...
  return (
    <section>
      ...
      <p>
        ...
        traditional requirements-driven engagements with contracted clients. Part of defining the
        PM role was establishing what discovery should look like in this new context. After the
