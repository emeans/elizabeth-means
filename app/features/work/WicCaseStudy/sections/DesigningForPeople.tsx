  ...
  return (
    <section>
      ...
      <p>
        ...
        visible expression of this was our health journey, a compassionate timeline surfacing
        health insights, education, and support for participants. But the philosophy permeated the
        entire system, representing a shift from administrative case management to genuine
      ...
      <p>
        ...
        decisions without me in the room. I developed a comprehensive design operations framework:
        process templates for research, design briefs, handoffs, and review checklists, a Figma
        organization and versioning system, UX writing guidelines covering voice, tone, and
        accessibility standards, a design delegation playbook defining roles and autonomy levels,
        and a design system with a component library and WCAG documentation. It was built to enable
        consistent delivery, faster onboarding, and higher velocity as the team scaled. Building it
        was also where the tension between doing and enabling was sharpest. I was doing significant
        design work while simultaneously building the systems that would eventually let me stop
        doing it myself.
      </p>
      <p>
        ...
        only happened because we kept validating rather than assuming we understood the
        requirements upfront, and it ensured we met complex regulations while maintaining
        usability.
      </p>
    </section>
  )
