...
export default function WhyThisMoment() {
  return (
    <section>
      ...
      <p>
        Early validation came quickly, and from an unexpected source. At the National WIC Association
        conference in Portland, our booth happened to be next to a third-party compliance
        investigator who worked directly with state agencies on vendor investigations. He walked
        through what we had built, asked sharp questions, and then said something that stuck:
