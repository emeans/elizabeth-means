    ...
    <>
      <section>
        ...
        <p>
          ...
          participant case management, vendor authorization, and food package administration. All
          three have to reconcile with each other in real time. A change to an approved food item
          ripples across vendor eligibility, participant benefits, and state compliance reporting
          simultaneously. It is a surprisingly complex system, and the software supporting it hadn't
          kept pace.
        </p>
        <p>
        ...
        <p>
          ...
          need to spend that money, and no modern commercial WIC MIS existed that could serve
          multiple states without heavy customization. They decided to build one from scratch: the
          company's first commercial product after 30 years of custom development.
        </p>
        <p>
          ...
          compliance investigator who worked directly with state agencies on vendor investigations.
          He walked through what we had built, asked sharp questions, and then said something that
          stuck: wouldn't it be something if he could log into a system like this out in the field
          and run his investigation directly? He wasn't a potential customer. He had no reason to
          flatter us. He was just describing, unprompted, a capability our product could naturally
          support. It was the kind of validation you can't manufacture.
        </p>
        <p>
